...
import papyel from "../assets/img/icon/papyel.png";
            ...
            <div class="row">
                <div class="col-12">
                    <div class="user-actions">
                        <h3> 
                            <i class="fa fa-file-o" ariaHidden="true"></i>
                            Returning customer?
                            <a class="Returning" href="checkout.html#checkout_login" data-bs-toggle="collapse" ariaExpanded="true">Click here to login</a>     
                    ...
                    <div class="user-actions">
                        <h3> 
                            <i class="fa fa-file-o" ariaHidden="true"></i>
                            Returning customer?
                            <a class="Returning" href="checkout.html#checkout_coupon" data-bs-toggle="collapse"  ariaExpanded="true">Click here to enter your code</a>     
                        ...
                        <form action="checkout.html#">
                            ...
                            <div class="payment_method">
                                ...
                                <div class="panel-default">
                                    ...
                                    <label for="payment_defult" data-bs-toggle="collapse" href="#collapsedefult" aria-controls="collapsedefult">PayPal <img src={papyel} alt="papyel" /></label>
