...
import arrowDown from "../assets/img/icon/arrow-down-white.svg";
...
const props = {zoomWidth: 500, img: product15};
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="product-details-tab">
                            ...
                            <div id="img-1" class="zoomWrapper single-zoom">
                                <a href="#">
                                    {/* <img  id="zoom1" src={product15} data-zoom-image={product15} alt="big-1" /> */}
                                    <ReactImageZoom {...props} />
                                </a>
                            </div>

                            <div class="single-zoom-thumb">
                                <OwlCarousel class="s-tab-zoom owl-carousel single-product-active ul" id="gallery_01" {...options}>
                                    <li>
                                        <a href="#" class="elevatezoom-gallery active" data-update="" data-image={product8} data-zoom-image={product8}>
                                            <img src={product8} alt="zo-th-1" />
                                        </a>

                                    </li>
                                    <li>
                                        <a href="#" class="elevatezoom-gallery active" data-update="" data-image={product9} data-zoom-image={product9}>
                                            <img src={product9} alt="zo-th-1" />
                                        </a>

                                    </li>
                                    <li>
                                        <a href="#" class="elevatezoom-gallery active" data-update="" data-image={product10} data-zoom-image={product10}>
                                            <img src={product10} alt="zo-th-1" />
                                        </a>

                                    </li>
                                    <li>
                                        <a href="#" class="elevatezoom-gallery active" data-update="" data-image={product13} data-zoom-image={product13}>
                                            <img src={product13} alt="zo-th-1" />
                                        </a>
                        ...
                        <div class="product_d_right">
                            <form action="/">
                                ...
                                <div class="product_nav">
                                    <ul>
                                        <li class="prev"><a href="product-details.html"><img src={arrowDown} alt="arrowDown" className='arrowDown-arrowLeft'/></a></li>
                                        <li class="next"><a href="variable-product.html"><img src={arrowDown} alt="arrowDown" className='arrowDown-arrowRight'/></a></li>
                                    </ul>
                                </div>
                                ...
                                <ul>
                                    ...
                                    <li><a class="google-plus" href="#" title="google +">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-google" viewBox="0 0 16 16">
                                         ...
                                         share</a></li>
                                    <li><a class="linkedin" href="#" title="linkedin">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-google" viewBox="0 0 16 16">
                                            <path d="M15.545 6.558a9.42 9.42 0 0 1 .139 1.626c0 2.434-.87 4.492-2.384 5.885h.002C11.978 15.292 10.158 16 8 16A8 8 0 1 1 8 0a7.689 7.689 0 0 1 5.352 2.082l-2.284 2.284A4.347 4.347 0 0 0 8 3.166c-2.087 0-3.86 1.408-4.492 3.304a4.792 4.792 0 0 0 0 3.063h.003c.635 1.893 2.405 3.301 4.492 3.301 1.078 0 2.004-.276 2.722-.764h-.003a3.702 3.702 0 0 0 1.599-2.431H8v-3.08h7.545z"/>
                                        </svg>
                                         linked</a></li>
                        ...
                        <div class="product_d_inner">
                            <div class="product_info_button">
                                <ul class="nav" role="tablist" id="nav-tab">
                                    <li onClick={() => isActive(!active)}>
                                        <a className={active ? "" : "active"} data-toggle="tab" href="#info" role="tab" aria-controls="info" aria-selected="false">Description</a>
                                    </li>
                                    <li onClick={() => isActive(!active)}>
                                        <a className={active ? "active" : ""} data-toggle="tab" href="#sheet" role="tab" aria-controls="sheet" aria-selected="false">Specification</a>
                                    </li>
                                    <li onClick={() => isActive(!active)}>
                                        <a className={active ? "active" : ""} data-toggle="tab" href="#reviews" role="tab" aria-controls="reviews" aria-selected="false">Reviews (1)</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content">
                                <div className={active ? "tab-pane fade" : "tab-pane fade show active"} id="info" role="tabpanel">
                                ...
                                <div className={active ? "tab-pane fade show active" : "tab-pane fade"} id="sheet" role="tabpanel">
                                ...
                                <div className={active ? "tab-pane fade show active" : "tab-pane fade"} id="reviews" role="tabpanel">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <OwlCarousel class="product_carousel product_column5 owl-carousel" {...options}>
                            <div class="single_product">
                                ...
                                <div class="product_thumb">
                                    ...
                                    <a class="secondary_img" href="product-details.html"><img src={product11} alt="product" /></a>
                            ...
                            <div class="single_product">
                                ...
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-details.html"><img src={product12} alt="product" /></a>
                                    <a class="secondary_img" href="product-details.html"><img src={product13} alt="product" /></a>
                                    <div class="label_product">
                            ...
                            <div class="single_product">
                                ...
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-details.html"><img src={product16} alt="product" /></a>
                                    <a class="secondary_img" href="product-details.html"><img src={product17} alt="product" /></a>
                                    <div class="label_product">
                                        <span class="label_sale">-57%</span>
                                    </div>
                            ...
                            <div class="single_product">
                                ...
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-details.html"><img src={product18} alt="product" /></a>
                            ...
                            <div class="single_product">
                                ...
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-details.html"><img src={product2} alt="product" /></a>
                                    <a class="secondary_img" href="product-details.html"><img src={product3} alt="product" /></a>
                                    <div class="label_product">
                                        <span class="label_sale">-57%</span>
                                    </div>
                            ...
                            <div class="single_product">
                                ...
                                <div class="product_thumb">
                                    <a class="primary_img" href="product-details.html"><img src={product4} alt="product" /></a>
                                    <a class="secondary_img" href="product-details.html"><img src={product5} alt="product" /></a>
                                    <div class="label_product">
                                        <span class="label_sale">-57%</span>
                                    </div>
