...
function Terms() {
  ...
  const [categoryOption] = useState(["Comments", "Media", "Cookies", "Embedded cont..", "How long we..", "What rights..", "Where we..", "Comments", "Media", "Cookies", "Embedded cont..", "Media", "Cookies", "How long we..", "What rights.."])
